...
public class StreamAnalyticsDriver implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            streamAnalyticsDriver.createRDD(sc, listOfSourcePids);
            streamAnalyticsDriver.invokeRDDOperations(emptyRDD,sc, listOfSourcePids, prevMap, nextPidMap,broadcastMap);
